            ...
            <div class="col-md-6">
                ...
                <form id="registerForm" method="POST" action="/user_register">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input id="email" class="form-control" type="email" name="email" required
                                oninput="showVerifyButton()">
                            <button id="verifyBtn" class="btn btn-primary d-none"
                                onclick="showOtpField()">Verify</button>
                        </div>
                    </div>
                    <div class="mb-3 d-none" id="otpDiv">
                        <label for="otp" class="form-label">Enter OTP <span class="text-danger">*</span></label>
                        <input id="otp" class="form-control" type="text" name="otp" maxlength="4"
                    ...
                    <button type="submit" class="btn  w-100"
                        style="background-color:orange; color:#fff;">Register</button>
                </form>
                ...
                <form id="loginForm" class="d-none" method="POST" action="/login">
                    ...
                    <button type="submit"
                        class="btn  w-100"style="background-color:orange; color:#fff;">Login</button>
